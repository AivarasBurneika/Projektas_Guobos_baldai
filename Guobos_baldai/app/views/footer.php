    ...
    <div  class="row">
      ...
      <div class="col l3 s12">
        ...
        <ul >
          ...
          <li><a class="black-text" href="../app/views/virtuve.php">Virtuvės baldai</a></li>
          <li><a class="black-text" href="../app/views/svetaine.php">Svetainės baldai</a></li>
          <li><a class="black-text" href="../app/views/sistemos.php">Slankiojančios sistemos</a></li>
        </ul>
      </div>
      <div  class="col l3 s12">
        ...
        <a class="black-text socila" href="https://www.facebook.com/Guobos-baldai-246022925538150/" target="_blank">
          <i  class="fa fa-facebook-official" style="font-size:36px"></i>
        </a>
        <a class="black-text social" href="https://twitter.com/" target="_blank">
