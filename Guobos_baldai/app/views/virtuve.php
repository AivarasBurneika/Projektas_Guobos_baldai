...
<body>
      ...
      <div class="row" >
        <div class="col s12 m6 l4">
          <div  class="icon-block">
            <div class="box1">
              <img id="virtuvesb1" class="myImg" src="../images/virtuve/virtuves1.jpg" alt="">
            </div>
          </div>
        </div>
        <div class="col s12 m6 l4">
          <div class="icon-block">
            <div class="box1">
              <img id="virtuvesb2" class="myImg" src="../images/virtuve/virtuves2.jpg" alt="">
            </div>
          </div>
        </div>
        <div class="col s12 m6 l4">
          <div class="icon-block">
            <div class="box1">
              <img id="virtuvesb3" class="myImg" src="../images/virtuve/virtuves3.jpg" alt="">
            </div>
          </div>
        </div>
        <div class="col s12 m6 l4" class="eile">
          <div  class="icon-block">
            <div class="box1">
              <img id="virtuvesb4" class="myImg" src="../images/virtuve/virtuves4.jpg" alt="">
            </div>
          </div>
        </div>
        <div class="col s12 m6 l4">
          <div class="icon-block">
            <div class="box1">
              <img id="virtuvesb5" class="myImg" src="../images/virtuve/virtuves5.jpg" alt="">
            </div>
          </div>
        </div>
        <div class="col s12 m6 l4">
          <div class="icon-block">
            <div class="box1">
              <img id="virtuvesb6" class="myImg" src="../images/virtuve/virtuves6.jpg" alt="">
            </div>
          </div>
        </div>
      </div>
  ...
  <div id="modal1" class="modal">
    <div class="modal-content white" id="formContent" >
      ...
      <div class="row">
        <form id="contact" action="../views/virtuve.php" method="post" class="col s12 forma">
  ...
  function changeImage(imageNumber) {
    $(".boxVirtuve").empty();
    var img = $("<img />");
    img.prop("src", "../images/virtuve/virtuves" + imageNumber + ".jpg");
